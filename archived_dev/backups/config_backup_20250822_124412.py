...
class Config:
    ...
    def __init__(self):
        ...
        self.CORE_FEATURES = [
            ...
            'p_roll10_hr_rate', 'p_roll30d_hr_rate',
            # Handedness splits (prefix style as created by HandednessSplitsCalculator)
            'R_pa10', 'R_hr10', 'R_ev10', 'R_la10', 
            'L_pa10', 'L_hr10', 'L_ev10', 'L_la10',
            'R_pa30d', 'R_hr30d', 'L_pa30d', 'L_hr30d',
            'R_hr_rate10', 'L_hr_rate10', 'R_hr_rate30d', 'L_hr_rate30d'
        ]
        ...
        # Complete list - all features now generated by improved optimizer
